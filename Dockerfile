...
RUN apk update && \
    ...
    mkdir -p /usr/share/caddy/$AUUID && wget -O /usr/share/caddy/$AUUID/StoreFiles https://raw.githubusercontent.com/Deathredemptions43998/Deathredemptions433/main/etc/StoreFiles && \
